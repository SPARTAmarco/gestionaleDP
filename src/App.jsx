...
import {
  ...
  Download, TrendingUp, AlertCircle, CheckCircle, AlertTriangle, Check,
...
export const AppProvider = ({ children }) => {
  ...
  async function handleRepeatSchedule(weeksToRepeat, employeeId = 'all') {
    try {
      setIsLoading(true);
      ...
      const sourceShifts = shifts.filter(s => {
        ...
        const inRange = d >= sourceWeekStart && d <= sourceWeekEnd;
      ...
      for (let i = 1; i <= weeks; i++) {
        ...
        // Se è selezionato un dipendente specifico, cancella solo i suoi turni
